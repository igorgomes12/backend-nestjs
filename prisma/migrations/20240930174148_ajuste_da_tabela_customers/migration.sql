/*
  ...
  - You are about to drop the `_CustomerSystemVersions` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "public"."Customer_System_Version" DROP CONSTRAINT "Customer_System_Version_version_id_fkey";
...
-- DropForeignKey
ALTER TABLE "public"."_CustomerSystemVersions" DROP CONSTRAINT "_CustomerSystemVersions_A_fkey";

-- DropForeignKey
ALTER TABLE "public"."_CustomerSystemVersions" DROP CONSTRAINT "_CustomerSystemVersions_B_fkey";
...
-- DropTable
DROP TABLE "public"."_CustomerSystemVersions";
