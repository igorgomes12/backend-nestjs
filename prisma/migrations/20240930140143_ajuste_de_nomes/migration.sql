/*
  ...
  - You are about to drop the `Systems_Version` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "public"."Systems_Version" DROP CONSTRAINT "Systems_Version_system_id_fkey";
...
-- DropTable
DROP TABLE "public"."Systems_Version";
