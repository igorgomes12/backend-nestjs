...
CREATE TABLE "Systems_Version" (
    ...
    CONSTRAINT "Systems_Version_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Client" ADD CONSTRAINT "Client_systemsId_fkey" FOREIGN KEY ("systemsId") REFERENCES "Systems"("id") ON DELETE NO ACTION ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Systems_Version" ADD CONSTRAINT "Systems_Version_system_id_fkey" FOREIGN KEY ("system_id") REFERENCES "Systems"("id") ON DELETE CASCADE ON UPDATE CASCADE;
