...
-- DropForeignKey
ALTER TABLE "public"."Customer_System_Version" DROP CONSTRAINT "Customer_System_Version_customer_id_fkey";
...
-- AddForeignKey
ALTER TABLE "Customer_System_Version" ADD CONSTRAINT "Customer_System_Version_customer_id_fkey" FOREIGN KEY ("customer_id") REFERENCES "System"("id") ON DELETE CASCADE ON UPDATE CASCADE;
