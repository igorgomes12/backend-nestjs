/*
  ...
  - You are about to drop the `PaymentsType` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "public"."Address" DROP CONSTRAINT "Address_representativeId_fkey";
...
-- DropForeignKey
ALTER TABLE "public"."Client" DROP CONSTRAINT "Client_representative_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."Client" DROP CONSTRAINT "Client_systemsId_fkey";

-- DropForeignKey
ALTER TABLE "public"."Commission" DROP CONSTRAINT "Commission_representativeId_fkey";

-- DropForeignKey
ALTER TABLE "public"."Contact" DROP CONSTRAINT "Contact_clientId_fkey";

-- DropForeignKey
ALTER TABLE "public"."Contact" DROP CONSTRAINT "Contact_representativeId_fkey";

-- DropForeignKey
ALTER TABLE "public"."ContractHistory" DROP CONSTRAINT "ContractHistory_contract_id_fkey";
...
-- DropTable
DROP TABLE "public"."ContractHistory";
...
-- DropTable
DROP TABLE "public"."PaymentsType";
...
-- DropEnum
DROP TYPE "public"."TypeRepresentative";
