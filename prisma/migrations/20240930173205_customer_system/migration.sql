...
CREATE TABLE "Customer_System_Version" (
    ...
    "assingned_date" TIMESTAMP(3) NOT NULL,
    "createdAt" TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3),
    "deletedAt" TIMESTAMP(3),
...
-- CreateTable
CREATE TABLE "_CustomerSystemVersions" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL
);
...
-- CreateIndex
CREATE UNIQUE INDEX "_CustomerSystemVersions_AB_unique" ON "_CustomerSystemVersions"("A", "B");

-- CreateIndex
CREATE INDEX "_CustomerSystemVersions_B_index" ON "_CustomerSystemVersions"("B");
...
-- AddForeignKey
ALTER TABLE "System_Version" ADD CONSTRAINT "System_Version_system_id_fkey" FOREIGN KEY ("system_id") REFERENCES "System"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Customer_System_Version" ADD CONSTRAINT "Customer_System_Version_version_id_fkey" FOREIGN KEY ("version_id") REFERENCES "System_Version"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_CustomerSystemVersions" ADD CONSTRAINT "_CustomerSystemVersions_A_fkey" FOREIGN KEY ("A") REFERENCES "Customer_System_Version"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_CustomerSystemVersions" ADD CONSTRAINT "_CustomerSystemVersions_B_fkey" FOREIGN KEY ("B") REFERENCES "System"("id") ON DELETE CASCADE ON UPDATE CASCADE;
